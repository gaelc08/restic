...
=== Backup ===
  Status: success  (2026-09-24T01:00:12+02:00)
  restic backup on manny-01 completed successfully in 42s (3 share(s)).

=== Maintenance ===
  Status: success  (2026-09-24T00:00:05+02:00)
...
delivery path as failure alerting (same MTA requirement). The shares
table looks up each share's latest snapshot ID individually
